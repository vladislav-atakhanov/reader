...
var app = (function () {
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$g, 27, 1, 484);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			attr_dev(h1, "class", "drag__title svelte-ppk8qd");
    			add_location(h1, file$2, 9, 2, 116);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "class", "drag__input svelte-ppk8qd");
    			attr_dev(input, "accept", ".fb2");
    			input.multiple = true;
    			add_location(input, file$2, 10, 2, 163);
    			attr_dev(label, "class", "drag svelte-ppk8qd");
    			add_location(label, file$2, 6, 1, 87);
    			attr_dev(div, "class", "wrapper svelte-ppk8qd");
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const input_handler = e => books.addFiles(e.target.files);
    	$$self.$capture_state = () => ({ books });
